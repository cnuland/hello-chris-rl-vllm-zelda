...
ABS_CLAMPS: dict[str, tuple[float, float]] = {
    "new_room": (1.0, 10.0),
    "directional_bonus": (1.0, 10.0),
    "distance_bonus": (0.5, 5.0),
    "dialog_bonus": (0.2, 3.0),
