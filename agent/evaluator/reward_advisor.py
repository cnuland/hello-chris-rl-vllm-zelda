...
ABS_CLAMPS: dict[str, tuple[float, float]] = {
    ...
    "maku_dialog": (30.0, 200.0),
    "gnarled_key": (30.0, 200.0),
    "maku_seed": (50.0, 400.0),
    "gate_slash": (15.0, 100.0),
    "maku_room": (5.0, 30.0),
    "maku_stage": (20.0, 150.0),
    "distance_bonus": (1.0, 15.0),
    "directional_bonus": (2.0, 25.0),
    "sword": (5.0, 30.0),
    "dungeon": (5.0, 30.0),
    "maku_tree": (5.0, 30.0),
